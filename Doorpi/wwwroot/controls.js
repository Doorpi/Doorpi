(() => {
    ...
    function installStyles() {
        ...
        style.textContent = `
            ...
            .cc-input-mode{min-width:0;min-height:66px;display:grid;grid-template-columns:38px minmax(0,1fr) auto;align-items:center;gap:10px;padding:7px 9px;border:1px solid transparent;border-radius:8px;background:rgba(255,255,255,.035)}.cc-input-mode[hidden]{display:none}.cc-input-mode-icon{display:grid;place-items:center;width:36px;height:36px;color:rgba(255,255,255,.72)}.cc-input-mode-icon svg{width:25px;height:25px}.cc-input-mode-copy{min-width:0;display:grid;gap:3px}.cc-input-mode-copy strong,.cc-input-mode-copy span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.cc-input-mode-copy strong{font-size:.76rem;font-weight:580}.cc-input-mode-copy span{color:var(--cc-muted);font-size:.64rem}.cc-input-mode-toggle{min-width:104px;min-height:40px;display:flex;align-items:center;justify-content:space-between;gap:10px;padding:0 11px;border:1px solid rgba(255,255,255,.18);border-radius:6px;background:transparent;color:rgba(255,255,255,.62);font:600 .68rem inherit}.cc-input-mode-toggle::after{content:'—';color:rgba(255,255,255,.45);font-size:.85rem}.cc-input-mode-toggle.on{border-color:rgba(255,255,255,.42);color:#fff;background:rgba(255,255,255,.08)}.cc-input-mode-toggle.on::after{content:'✓';color:#fff}.cc-input-mode-toggle:disabled{opacity:.5}.cc-input-mode-toggle:focus,.cc-input-mode-toggle.cc-focused{outline:0;border-color:#fff;box-shadow:0 0 0 2px rgba(255,255,255,.22)}.cc-selector:disabled{opacity:.4}.cc-input-lock{height:100%;display:grid;place-content:center;justify-items:center;gap:10px;border:1px solid var(--cc-line);border-radius:10px;background:rgba(255,255,255,.018);color:var(--cc-muted);text-align:center}.cc-input-lock svg{width:38px;height:38px;color:rgba(255,255,255,.32)}.cc-input-lock strong{color:#fff;font-size:1rem;font-weight:520}.cc-input-lock span{max-width:470px;font-size:.74rem;line-height:1.5}.cc-controller-context-icon{display:grid!important;place-items:center;width:25px!important}.cc-controller-context-icon svg{width:25px;height:19px}
            ...
            .cc-overlay:not(.cc-global-mode) .cc-top{grid-row:1}.cc-overlay:not(.cc-global-mode) .cc-context{grid-row:2}.cc-overlay:not(.cc-global-mode) .cc-tabs{grid-row:3}.cc-overlay:not(.cc-global-mode) .cc-content{grid-row:4}.cc-overlay:not(.cc-global-mode) .cc-footer{grid-row:5}.cc-overlay.cc-global-mode .cc-top{grid-row:1}.cc-overlay.cc-global-mode .cc-content{grid-row:2}.cc-overlay.cc-global-mode .cc-footer{grid-row:3}
            ...
            @media(max-width:1120px){.cc-context{grid-template-columns:minmax(200px,1fr) minmax(200px,1fr) minmax(235px,.82fr)}.cc-workspace{grid-template-columns:minmax(430px,1.2fr) minmax(300px,.8fr)}.cc-workspace.with-pointer .cc-pointer-panel{grid-template-columns:1fr}}
            @media(max-width:840px){.cc-shell{overflow:hidden}.cc-context{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.cc-context .cc-input-mode{grid-column:1/-1}.cc-content{overflow-y:auto}.cc-content-inner{height:auto;min-height:100%}.cc-workspace,.cc-workspace.with-pointer{height:auto;grid-template-columns:1fr;grid-template-rows:auto}.cc-command-panel,.cc-workspace.with-pointer .cc-command-panel{grid-column:1;grid-row:auto;min-height:min(480px,58vh)}.cc-detail-panel,.cc-workspace.with-pointer .cc-detail-panel{grid-column:1;grid-row:auto;min-height:420px}.cc-pointer-panel,.cc-workspace.with-pointer .cc-pointer-panel{grid-column:1;grid-row:auto}.cc-footer-hints{display:none}}
            @media(max-height:820px){.cc-top{padding-top:16px;padding-bottom:9px;row-gap:4px}.cc-brand h1{font-size:1.8rem}.cc-brand p{display:none}.cc-mode-btn{min-height:34px}.cc-context{padding-top:7px;padding-bottom:9px}.cc-selector,.cc-input-mode{min-height:54px}.cc-app-art,.cc-profile-art{width:42px;height:42px}.cc-input-mode-icon{width:32px;height:32px}.cc-tabs{min-height:44px}.cc-content{padding-top:12px;padding-bottom:13px}.cc-section-head{padding-top:13px;padding-bottom:13px}.cc-row{min-height:59px}.cc-add-row{min-height:49px}.cc-footer{min-height:52px}}
            @media(max-width:840px) and (max-height:600px){.cc-top{grid-template-columns:auto minmax(0,1fr) auto;grid-template-areas:'brand modes close';align-items:center;column-gap:16px;padding:9px 24px 7px}.cc-breadcrumb{display:none}.cc-brand h1{font-size:1.5rem}.cc-mode-switch{align-self:center;gap:13px}.cc-mode-btn{min-height:34px;font-size:.7rem}.cc-close{align-self:center;width:42px;min-height:40px}.cc-context{grid-template-columns:minmax(150px,1fr) minmax(150px,1fr) minmax(190px,1fr);gap:8px;padding:6px 24px}.cc-context .cc-input-mode{grid-column:auto}.cc-label{display:none}.cc-selector{min-height:46px;grid-template-columns:34px minmax(0,1fr) auto;gap:8px;padding:4px 7px 4px 4px}.cc-selector>span>span,.cc-input-mode-copy span{display:none}.cc-selector em{font-size:0}.cc-selector em::after{margin-left:0}.cc-app-art,.cc-profile-art{width:34px;height:34px}.cc-input-mode{min-height:46px;grid-template-columns:28px minmax(0,1fr) auto;gap:7px;padding:4px 6px}.cc-input-mode-icon{width:27px;height:27px}.cc-input-mode-icon svg{width:21px;height:21px}.cc-input-mode-copy strong{font-size:.66rem}.cc-input-mode-toggle{min-width:74px;min-height:34px;padding:0 8px;font-size:.61rem}.cc-tabs{min-height:38px;padding-inline:24px}.cc-tab{min-width:92px;font-size:.73rem}.cc-tab-hint{display:none}.cc-content{padding:8px 24px}.cc-footer{height:48px;min-height:48px;padding-inline:24px}.cc-footer .cc-btn.primary{min-width:128px}}
        `;
    ...
    function syncOverlayViewport() {
        ...
        // O WebView2 já aplica DoorpiLayoutScale por ZoomFactor e recalcula o
        // viewport CSS. Compensar a escala outra vez aqui aumentava o overlay
        // além do viewport e cortava justamente a tela de Controles.
        state.overlay.style.removeProperty('width');
        state.overlay.style.removeProperty('height');
    }
    ...
    function renderContent() {
        ...
        const addLabel = state.mode === 'global' ? tx('addGlobal') : state.tab === 'mouse' ? tx('addMouse') : tx(isYouTubeProfile() ? 'addRemoteCommand' : 'addKeyboard');
        const addAttribute = state.mode === 'global' ? 'data-add-global' : state.tab === 'mouse' ? 'data-add-mouse' : 'data-add-keyboard';
        const addAction = `<button class="cc-row cc-add-row" data-cc-focus ${addAttribute}><span class="cc-row-icon">${iconSvg('plus')}</span><span class="cc-row-copy"><span class="cc-row-title">${addLabel}</span></span><span class="cc-row-chevron">${iconSvg('chevron')}</span></button>`;
        host.innerHTML = `<div class="cc-workspace">
            <section class="cc-command-panel"><div class="cc-section-head"><div><h2>${heading}</h2><p>${description}</p>${isBuiltIn() && state.mode !== 'global' ? `<p class="cc-fork-inline">${tx('profileFork')}</p>` : ''}</div></div><div class="cc-list">${addAction}${bindings.length ? bindings.map(bindingRow).join('') : `<div class="cc-empty">${state.tab === 'mouse' ? tx('emptyMouse') : tx('emptyKeyboard')}</div>`}</div></section>
            ${detailPanelHtml()}
        </div>`;
        wireContent();
    }
    ...
    function navigate(direction) {
        ...
        const selectedRow=rows.find(item=>item.classList.contains('selected'))||rows.find(item=>item.hasAttribute('data-binding-select'))||rows[0];
        let target=null;
        if (modes.includes(active)) {
            ...
            else if (direction==='DOWN') target=state.mode==='global'?(headActions[0]||rows[0]||detail[0]||footer[0]):(context[0]||activeTab);
        } else if (top.includes(active)) {
            if (direction==='LEFT') target=modes[modes.length-1]||activeMode;
            else if (direction==='DOWN') target=state.mode==='global'?(rows[0]||detail[0]):(context[context.length-1]||activeTab);
            ...
            else if (direction==='DOWN') target=activeTab||rows[0];
            ...
            else if (direction==='UP') target=context[Math.min(index,Math.max(0,context.length-1))]||activeMode;
            ...
            else if (direction==='RIGHT') target=active.classList.contains('cc-add-row')?active:(detail[0]||active);
            else target=active;
            ...
            const upperTarget = activeTab||activeMode;

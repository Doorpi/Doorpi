...
const STRINGS = {
    'pt-BR': {
        ...
        // ---- Atualizacoes e status de sistema ----
        sysUpdateBadgeUpdated: 'ATUALIZADO',
        sysUpdateTitle: 'Atualizacoes do sistema',
        sysUpdateIdle: 'Atualizacoes ainda nao verificadas.',
        sysUpdateAvailableTitle: 'Atualizacao disponivel',
        sysUpdateNoChangelog: 'Notas da versao aparecerao aqui quando o manifesto estiver configurado.',
        sysUpdateCheckNow: 'Verificar agora',
        sysUpdateCheckNowDesc: 'Consulta o manifesto remoto e mostra versoes, changelog e obrigatoriedade.',
        sysUpdateStart: 'Atualizar',
        sysUpdateStartDesc: 'Baixa o pacote validado, atualiza componentes e reinicia o Doorpi se necessario.',
        updateBadgeText: 'Atualizacao',
        updateBadgeAvailableTitle: 'Atualizacao do sistema disponivel',
        updateBadgeIdleTitle: 'Nenhuma atualizacao pendente',
        updatePromptKicker: 'Atualizacao do sistema',
        updatePromptInitialTitle: 'Nova versao disponivel',
        updatePromptWarning: 'Nao desligue o computador durante a instalacao.',
        updatePromptStart: 'Atualizar agora',
        updatePromptLater: 'Depois',
        updatePromptSystemComponents: 'componentes do sistema',
        updatePromptTitle: (scope) => `Atualizacao disponivel para ${scope}`,
        updatePromptSubtitle: 'Voce pode instalar agora ou deixar para depois. O aviso fica salvo na Home para atualizar quando quiser.',
        updatePromptNoChangelog: 'Notas da versao ainda nao informadas no manifesto.',
        ...
        // ---- Sessoes / execution lock ----
        genericGameName: 'Jogo',
        genericStoreName: 'Loja',
        runningGameName: 'Jogo em execucao',
        runningStoreName: 'Loja em execucao',
        runningSessionName: 'Sessao em execucao',
        storeInstallRunning: 'Instalacao em andamento',
        pairRoleGame: 'Jogo',
        pairRoleStore: 'Loja',
        executionLockRestore: 'Retomar',
        executionLockCloseProcess: 'Fechar processo',
        executionLockCancelInstall: 'Cancelar instalacao',
        executionLockStatusRunning: 'EM EXECUCAO',
        sessionConflictAriaLabel: 'Conflito de sessao',
        sessionConflictActiveKicker: 'Sessao ativa',
        sessionConflictDefaultMessage: 'Uma sessao ja esta ativa. Encerre a sessao atual para iniciar outra.',
